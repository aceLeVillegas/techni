...
<body>
    ...
    <div class = "categories">
        <ul class="menu">
            ...
            <li><a class="visited" href="gift.php?artWork=4">Gift Cards</a></li>
    ...
    <div id="content">
      ...
      <div id="filters">
         ...
         <br>  Artist <select class = "select" name="artist" value="">
            ...
            <br> <br> Style <select class = "select" name="style" value="">
                <option value="6">6X6</option>
                <option value="7">7X7</option>
                <option value="8">8X8</option>
                <option value="9">9X9</option>
            ...
            <br> Time Period <select class = "select" name="style" value="">
                <option value="6">6X6</option>
                <option value="7">7X7</option>
                <option value="8">8X8</option>
                <option value="9">9X9</option>
                ...
                <br><br>
        Sort by Price <input  type="radio" name="radio" value="10"> Ascending 
        <input class="radio" type="radio" name="radio" value="30"> Descending
        <br>    
